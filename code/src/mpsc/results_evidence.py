...
def validate_subject_manifest(
    ...
    *,
    ...
    if manifest.get("contract_level_mr_binding_count_available") != 0:
        errors.append("contract-level MR binding count available must be zero")
    ...
    return {
        ...
        "contract_level_mr_binding_count_available": 0,
        "errors": errors,
    }
